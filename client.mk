...
ifeq (,$(wildcard $(MOZCONFIG_LOADER)))
$(error Please run "python client.py checkout" to checkout the Mozilla source code)
endif
...
CONFIG_STATUS_DEPS := \
	$(wildcard $(CONFIGURES)) \
	$(TOPSRCDIR)/instantbird/config/version.txt \
	$(TOPSRCDIR)/purple/config/version.txt \
